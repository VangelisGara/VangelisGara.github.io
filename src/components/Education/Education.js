   ...
   render() {
      return (
         <div className="my-auto mobile">
            <h2
               className={"mb-5 " + (this.props.isgreek ? "greekcathdr" : null)}
            >
            ...
            <div className="resume-item d-flex flex-column flex-md-row mb-5">
               <div className="resume-content mr-auto">
                  <h3
                     className={
                        "mb-0 " + (this.props.isgreek ? "greekedu" : null)
                     }
                  >
                     {this.props.isgreek
                  ...
                  <p>
                     {this.props.isgreek ? "Μέσος Όρος" : "Average Rate"}: 7.52
                  </p>
               </div>
            ...
            <div className="resume-item d-flex flex-column flex-md-row mb-5">
               <div className="resume-content mr-auto">
                  <h3
                     className={
                        "mb-3 " + (this.props.isgreek ? "greekedu" : null)
                     }
                  >
                     {this.props.isgreek
