...
class about extends Component {
   emailClicked = () => {
      alertify.notify("Copied to clipboard!", "default", 3);
         ...
         <div className="my-auto mobile">
            ...
            <p className="lead mt-2 mb-4">
               {this.props.isgreek
                  ...
                  : "I am a passdfasionate developer that loves to bring pieces of code and design artifacts to life. I have completed numerous projects in fields of Artificial Intelligence, Machine Learning, Web Development, Data Structures etc. I am currently focusing in Full-Stack development and UX design. I am highly analytical and I have an endless curiosity that drives me on learning new things."}
            </p>
