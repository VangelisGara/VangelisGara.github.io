...
class Portfolio extends Component {
   ...
   render() {
      ...
      var lang_icon = !this.state.isGr ? (
         <img
            className="flag"
            src={require("./assets/images/GR.png")}
            alt="eng"
         />
      ) : (
         <img
            className="flag"
            src={require("./assets/images/GB.png")}
            alt="gr"
         />
      );
         ...
         <div className="App">
                  ...
                  <Nav navbar>
                     ...
                     <NavItem>
                        <Link
                           ...
                           duration={500}
                        >
                           {this.state.isGr ? "Εμπειρια" : "Experience"}
                        </Link>
                     </NavItem>
                     <NavItem>
                        <Link
            ...
            <div className="container-fluid p-1">
               ...
               <section
                  ...
                  id="highlights"
               >
                  <Experience isgreek={this.state.isGr} />
               </section>
               {/* Intersets Section */}
               <hr className="m-0" />
               <section
